    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            Padding(
              padding: EdgeInsetsDirectional.fromSTEB(16.0, 52.0, 16.0, 32.0),
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          context.pushNamed(AlbumListWidget.routeName);
                        },
                        child: Container(
                          width: MediaQuery.sizeOf(context).width * 1.0,
                          height: 40.0,
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          context.pushNamed(ArtistSaveWidget.routeName);
                        },
                        child: Container(
                          width: MediaQuery.sizeOf(context).width * 1.0,
                          height: 40.0,
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          context.pushNamed(ArtistSelectionWidget.routeName);
                        },
                        child: Container(
                          width: MediaQuery.sizeOf(context).width * 1.0,
                          height: 40.0,
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          Expanded(
                                            child: Text(
                                              'Experience your music in high quality and savor the melodies. 🎶',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelSmall
                                                      .override(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Expanded(
                                              child: Text(
                                                'Improve Music streaming over HTTP networks',
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .labelSmall
                                                    .override(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Expanded(
                                              child: Text(
                                                'crossfade is basically blending the tracks as one stops and the other starts',
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .labelSmall
                                                    .override(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Expanded(
                                              child: Text(
                                                'Download your favorite tunes and enjoy them at your leisure. 🎵',
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .labelSmall
                                                    .override(
