...
import '/components/upload_loop_dialog/upload_loop_dialog_widget.dart';
import '/components/music_loop_card/music_loop_card_widget.dart';
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            Padding(
              padding: EdgeInsetsDirectional.fromSTEB(16.0, 130.0, 16.0, 32.0),
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: () {
                              showDialog(
                                context: context,
                                builder: (context) => UploadLoopDialogWidget(),
                              );
                            },
                            child: Container(
                              padding: EdgeInsetsDirectional.fromSTEB(
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 32.0),
                      child: StreamBuilder<List<MusicLoopRecord>>(
                        stream: _model.musicLoopsStream,
                        builder: (context, snapshot) {
                          ...
                          List<MusicLoopRecord> musicLoops = snapshot.data!;

                          if (musicLoops.isEmpty) {
                            return Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  SizedBox(height: 8.0),
                                  Text(
                                    'Upload your first loop to get started!',
                                    style: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                                          font: GoogleFonts.outfit(
                    ...
                    Padding(
                      ...
                      child: Builder(
                        builder: (context) {
                          final dailyMotivation = List.generate(
                              random_data.randomInteger(5, 5),
                              (index) => random_data.randomImageUrl(
                                    0,
                                    0,
                        ...
                        builder: (context) {
                          ...
                          return SingleChildScrollView(
                            ...
                            child: Row(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.center,
                              children:
                                  List.generate(image4.length, (image4Index) {
            ...
            wrapWithModel(
              model: _model.discoverComponentModel,
              updateCallback: () => safeSetState(() {}),
              child: DiscoverComponentWidget(),
            ),
          ],
        ),
      ),
